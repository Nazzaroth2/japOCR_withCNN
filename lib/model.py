...
class AnalizerCNN(nn.Module):
    def __init__(self,cardinality, depth, nlabels, base_width, widen_factor=4):
        ...
        self.conv_1_3x3 = nn.Conv2d(3,64,3,stride=1,padding=1,bias=False)
    ...
    def forward(self, x):
        ...
        # print(x.size())
        x = self.stage_3.forward(x)     #(25x25) cause imgShape does not get changed
        # print(x.size())
        x = F.avg_pool2d(x, 7, 1)       #([101,1024,1,1])
        # print(x.size())
        # print("+++++++++++++++++++++")
